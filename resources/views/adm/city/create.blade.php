        ...
        <div class="">
            ...
            <div class="row">
                <div class="col-md-12 col-sm-12">
                    <div class="x_panel">
                        <div class="x_title">
                            <h2>Registro de Nueva Ciudad </h2>
                        ...
                        <div class="">
                            <a class="btn-orange-500 btn text-white btn-sm" href="{{ route('adm.cities.index') }}"><i
                                    class="fa fa-solid fa-arrow-left"></i>
                                Regresar</a>
                        </div>
                        <div class="x_content">
                            <form action="{{ route('adm.cities.store') }}" method="post">
                                @csrf
                                <div class="row">
                                    <div class="mb-4 col-sm-12 col-md-4">
                                        ...
                                        <input type="text" class="form-control @error('name') is-invalid @enderror"
                                            ...
                                            placeholder="Nueva Ciudad" value="{{ old('name') }}">
                                        @if ($errors->any())
                                            @error('name')
                                                <small id="namehelpId"
