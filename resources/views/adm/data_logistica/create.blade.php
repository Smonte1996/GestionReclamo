        ...
        <div class="">
            ...
            <div class="row">
                <div class="col-md-12 col-sm-12">
                    <div class="x_panel">
                        <div class="x_title">
                            <h2>Registro de Nuevo Data Logistica</h2>
                        ...
                        <div class="x_content">
                            <form action="{{route('adm.data_logisticas.store')}}" method="post">
                                @csrf
                                <div class="row">
                                    <div class="mb-3 col-sm-12 col-md-4">
                                        ...
                                        <input type="text" class="form-control @error('sku_quala') is-invalid @enderror"
                                            ...
                                            placeholder="Nuevo Sku Quala" value="{{ old('sku_quala') }}">
                                            @error('sku_quala')
                                        ...
                                        <div class="mb-3 col-sm-12 col-md-4">
                                           ...
                                           <input type="text" class="form-control @error('sku_unilever') is-invalid @enderror"
                                            ...
                                            placeholder="Nuevo Sku Unilever" value="{{ old('sku_unilever') }}">
                                            @error('sku_unilever')
                                        ...
                                        <div class="mb-3 col-sm-12 col-md-4">
                                           ...
                                           <input type="text" class="form-control @error('cliente') is-invalid @enderror"
                                            ...
                                            placeholder="Nuevo Cliente" value="{{ old('cliente') }}">
                                            @error('cliente')
                                        ...
                                        <div class="mb-3 col-sm-12 col-md-4">
                                           ...
                                           <input type="text" class="form-control @error('descripcion') is-invalid @enderror"
                                            ...
                                            placeholder="Nueva Descripcion" value="{{ old('descripcion') }}">
                                            @error('descripcion')
                                        ...
                                        <div class="mb-3 col-sm-12 col-md-4">
                                           ...
                                           <input type="text" class="form-control @error('ean13') is-invalid @enderror"
                                            ...
                                            placeholder="Nueva Ean 13" value="{{ old('ean13') }}">
                                            @error('ean13')
                                        ...
                                        <div class="mb-3 col-sm-12 col-md-4">
                                           ...
                                           <input type="text" class="form-control @error('ean14') is-invalid @enderror"
                                            ...
                                            placeholder="Nueva Ean 14" value="{{ old('ean14') }}">
                                            @error('ean14')
                                        ...
                                        <div class="mb-3 col-sm-12 col-md-4">
                                           ...
                                           <input type="text" class="form-control @error('ean128') is-invalid @enderror"
                                            ...
                                            placeholder="Nueva Ean 128" value="{{ old('ean128') }}">
                                            @error('ean128')
                                        ...
                                        <div class="mb-3 col-sm-12 col-md-4">
                                           ...
                                           <input type="text" class="form-control @error('registro_sanitario') is-invalid @enderror"
                                            ...
                                            placeholder="Nueva Resgitro Sanitario" value="{{ old('registro_sanitario') }}">
                                        ...
                                        <div class="mb-3 col-sm-12 col-md-4">
                                           ...
                                           <input type="text" class="form-control @error('vida_util') is-invalid @enderror"
                                            ...
                                            placeholder="Nueva Vida Util" value="{{ old('vida_util') }}">
                                            @error('vida_util')
                                        ...
                                        <div class="mb-3 col-sm-12 col-md-4">
                                           ...
                                           <input type="text" class="form-control @error('pvp') is-invalid @enderror"
                                            ...
                                            placeholder="Nueva PVP" value="{{ old('pvp') }}">
                                            @error('pvp')
                                                <small id="pvphelpId"
                                                    class="form-text text-muted invalid-feedback">{{ $message }}</small>
                                            @enderror
                                        ...
                                        <div class="mb-3 col-sm-12 col-md-4">
                                           ...
                                           <input type="text" class="form-control @error('cajas_plancha') is-invalid @enderror"
                                            name="cajas_plancha" id="caja_plancha"  aria-describedby="cajas_planchahelpId"
                                            placeholder="Nueva Cajas por plancha" value="{{ old('cajas_plancha') }}">
                                            @error('cajas_plancha')
                                        ...
                                        <div class="mb-3 col-sm-12 col-md-4">
                                           ...
                                           <input type="text" class="form-control @error('plancha_estibas') is-invalid @enderror"
                                            ...
                                            placeholder="Nueva Plancha por estiba" value="{{ old('plancha_estibas') }}">
                                        ...
                                        <div class="mb-3 col-sm-12 col-md-4">
                                           ...
                                           <input type="text" class="form-control @error('cajas_estibas') is-invalid @enderror"
                                            ...
                                            placeholder="Nueva Cajas por estiba" value="{{ old('cajas_estibas') }}">
                                            @error('cajas_estibas')
                                        ...
                                        <div class="mb-3 col-sm-12 col-md-4">
                                           ...
                                           <input type="text" class="form-control @error('marca') is-invalid @enderror"
                                            ...
                                            placeholder="Nueva Marca" value="{{ old('marca') }}">
                                            @error('marca')
                                        ...
                                        <div class="mb-3 col-sm-12 col-md-4">
                                           ...
                                           <input type="text" class="form-control @error('fecha_actualizacion') is-invalid @enderror"
                                            name="fecha_actualizacion" id="fecha_actualizacion"  aria-describedby="fecha_actualizacionhelpId"
                                            placeholder="Nueva Fecha de actualizacion" value="{{ old('fecha_actualizacion') }}">
                                        ...
                                        <div class="mb-3 col-sm-12 col-md-4">
                                           ...
                                           <input type="text" class="form-control @error('origen') is-invalid @enderror"
                                            ...
                                            placeholder="Nueva Origen" value="{{ old('origen') }}">
                                            @error('origen')
                                        ...
                                        <div class="mb-3 col-sm-12 col-md-6">
                                           ...
                                           <textarea class="form-control @error('observacion') is-invalid @enderror"
                                            ...
                                            placeholder="Nueva Observación" value="{{ old('observacion') }}"></textarea>
                                            @error('observacion')
