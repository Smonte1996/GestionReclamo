                            ...
                            <div class="x_content">
                                ...
                                <div class="row m-0 mb-3">
                                    ...
                                    <table width="100%" class="pt-3 border border-dark" cellspacing="0" cellpadding="3">
                                        <tr>
                                            <td colspan="3" class="border border-dark text-center" style="font-size:15px; background-color:darkgreen; color:white;">
                                                  <strong> Tareas Pendientes: {{$consulta->count()}} </strong>
                                            </td>
                                        </tr>
                                        <tr>
                                    ...
                                    <table  width="100%" class="border border-dark" cellspacing="0" cellpadding="3">
                                       <tr>
                                        ...
                                        @foreach ($consulta as $tasks)
                                       <tr>
                                        <td class="text-center border border-dark" style="font-size: 10px;">
                                            {{$tasks->Supervisores->name}}
                                        </td>
                                        <td class="text-center border border-dark" style="font-size: 10px;">
                                            {{$tasks->Personal->name}} {{$tasks->Personal->lastname}}
                                        </td>
                                        <td class="text-center border border-dark" style="font-size: 11px;">
                                             {{$tasks->uc2}}
                                        </td>
                                        <td class="text-center border border-dark" style="font-size: 11px;">
                                             {{$tasks->bl2}}
                                        ...
                                        <td class="text-center border border-dark" >
                                                ...
                                                <input type="checkbox" name="checklistRansa"
