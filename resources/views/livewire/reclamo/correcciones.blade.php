                        ...
                        <div class="x_panel">
                            ...
                            <div class="x_content">
                                ...
                                <fieldset class="border border-2">
                                    <legend class="rounded w-50 d-none d-sm-block float-none bg-lead-500 text-white ps-5 ms-4">Corrección</legend>
                                        <legend class="rounded float-none d-sm-none bg-lead-500 text-white fs-6 p-1">Corrección</legend>                                        
                                    <div class="ms-4">
