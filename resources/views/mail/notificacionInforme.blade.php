...
<p class="negro">En el documento adjunto puede encontrar el reporte de muestreo del contenedor/placa {{$Mustreo->contenedor}} recibida el {{$Mustreo->fecha_recepcion}}.</p>
